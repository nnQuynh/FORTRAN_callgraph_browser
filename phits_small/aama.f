...
!                                                                      *
 ...
 6700 format(a1,18h* e17,e18 quan.dep,4(1h/,i2,1h,,i2,1h,,i2,1h,,i2,&
      1h,,i2),28h(all/-1=start ran) do depol=,i1,13h(0/0=y,1=n) *)
...
14100 format(53h *** warning *** factorial divider not in any reasona,&
      60hble range (0.01-99.99) *** could cause severe arithmetic pro,&
      8hblems **)
...
!ABE 2018/10/30, add threadprivate aamac
      common /aamac01/ iread,iw,ipunch,iprint
!$OMP THREADPRIVATE(/aamac01/)
      common /aamac02/ ffact(60),ffactd
!$OMP THREADPRIVATE(/aamac02/)
...
!  ***note -- non-standard way of overprinting -- change as needed
!  ***standard fortran requires data for i9 /1h ,1h+,1h+,1h+/
      data i9, l9 / 1h+, 1h+, 1h+, 1h , 2h--/
      data k9 / 2hrd, 2h1s, 2h2t, 2h3t, 2hrd,&
                2h1s, 2h2s, 2h3s, 2hrd, 2h**,&
                2h2p, 2h3p, 2hrd, 2h**, 2h**,&
                2h3d/
...
!abe end
  ...
  980   format(//51h *** too many divide checks *** execution terminate,&
        17hd --- no dump ***//)
  990   format(8h *** n1=,i2,4h l1=,i2,5h, n2=,i2,4h l2=,i2/5x,3hxm=,1pe12&
        .5,4h t0=,e12.5,4h g0=,e12.5,5h zt(,i3,2h)=,e12.5/5x,6hpc0(k1,&
...
!abe add for get initial population
          if(n1 .eq. nmax) then
           popul(ll1) = pnl(k1)
          endif
!abe end
...
!                                                                      *
!  ***  numerical accuracy control -- computes diagonal m.e.
!                                                                      *
!***********************************************************************
...
!ABE 2018/12/05, add threadprivate aamac
      common /aamac01/ iread,iw,ipunch,iprint
!$OMP THREADPRIVATE(/aamac01/)
      common /aamac16/ ic,ll(20)
!$OMP THREADPRIVATE(/aamac16/)
...
!                                                                      *
!  ***  finds relative population of all possible j-states
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  puts information for line intensities in compact form to save
!                                                                      *
!***********************************************************************
...
!                                                                      *
      subroutine aamasort
!                                                                      *
!  ***  arranges line intensities in energy for the x-ray table         
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  master rate routine -- interprets options and calls other rates
!  ***  point dirac or inputed energies used exclusively in rates ***
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  monopole rate routine (penetration only)                        
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***quadrupole penetration routine
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  dipole unpenetrated rates routine                               
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  quadrupole unpenetrates rates routine
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  octupole unpenetrated rates routine                             
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  general dimensionless muonic matrix element for penetration
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  general dimensionless muonic matrix element for nonpenetration
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***  point-like dirac energy function
!                                                                      *
!***********************************************************************
...
!                                                                      *
      function id(a)
!                                                                      *
!  ***  used in decyphering to convert characters into numbers          
!                                                                      *
!***********************************************************************
...
!                                                                      *
!  ***used by check to find the exact expectation values
!                                                                      *
!***********************************************************************
...
!                                                                      *
      block data aama
!                                                                      *
!  ***  block data with all intrinsic parameters and default values     
!                                                                      *
!***********************************************************************
...
!-----------------------------------------------------------------------
!     default parameter in input card
!-----------------------------------------------------------------------
...
& !              k-shell       l-shell       m-shell
          ...
          8.701000d+2,  2.835000d+1,  0.000000d+0,&
          ...
          4.038100d+3,  3.701500d+2,  2.398000d+1,&
          ...
          9.658600d+3,  1.068950d+3,  4.846667d+1,&
          ...
          1.799760d+4,  2.320725d+3,  2.600333d+2,&
          ...
          2.920010d+4,  4.119600d+3,  6.122222d+2,&
     ...
     6    4.356890d+4,  6.565825d+3,  1.167311d+3,&
          ...
          6.133230d+4,  9.587950d+3,  1.800744d+3,&
          ...
          8.310230d+4,  1.340395d+4,  2.687644d+3,&
          ...
          1.096500d+5,  1.819125d+4,  3.898111d+3,&
          ...
          1.419260d+5,  2.398775d+4,  5.307889d+3,&
