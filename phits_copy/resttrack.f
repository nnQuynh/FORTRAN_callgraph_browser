************************************************************************
*                                                                      *
      subroutine check_ttrack(m,iax,jsn,jsi,dsin,idsi,ill,ilf,ierr)
*                                                                      *
...
*-----------------------------------------------------------------------
  ...
  999 continue
         ...
         ErrID = 'L:1272/R:check_ttrack/F:resttrack.f' !E51_001_001
...
************************************************************************
*                                                                      *
      subroutine read_ttrack(m,iax,ierr)
*                                                                      *
*   m: the tally number, index of ital.                                *
************************************************************************
...
*-----------------------------------------------------------------------
     ...
     &                rtami(itlmax), rtama(itlmax), rtadl(itlmax)
        ...
        dimension idas(mdas*2) !temporary for fbounds-check
        equivalence ( das, idas )
...
************************************************************************
*                                                                      *
      subroutine read_tracreg(m,iax,ioe,jsn,jsi,dsin,idsi,ill,ilf,
...
*-----------------------------------------------------------------------
        if( itaxs(m,iax) .eq. 1
     &       .or.(itaxs(m,iax).eq.15.and.iredufmt(m).eq.0)) then !FURUTA20200601
...
*-----------------------------------------------------------------------
     ...
     &                        '#numiefluxr.err',13,ierr)
             ...
             it=1
             do
              read(jsi,*)ir,ie,flux,e_flux
              if(ir.eq.0)exit
              tr(ip,ie,it,ir,im,1)=flux
              tr(ip,ie,it,ir,im,2)=e_flux
             enddo
...
************************************************************************
*                                                                      *
      subroutine read_tractet(m,iax,ioe,jsn,jsi,dsin,idsi,ill,ilf,
...
************************************************************************
*                                                                      *
      subroutine read_tracrz(m,iax,ioe,jsn,jsi,dsin,idsi,ill,ilf,
...
************************************************************************
*                                                                      *
      subroutine read_tracxyz(m,iax,ioe,jsn,jsi,dsin,idsi,ill,ilf,
