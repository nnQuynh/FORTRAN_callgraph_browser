...
23503 if(not-5)236,540,550
 ...
 3130 rlke = 2500.0d0
      write(ErrCha,*) '*** Warning ; BERT26, rlke is greater than 2500'
      ErrID = 'L:208/R:bert/F:bert.f' !W00_002_001
 ...
 3135 rlke = 2500.0d0
      write(ErrCha,*) '*** Warning ; BERT27, rlke is greater than 2500'
      ErrID = 'L:223/R:bert/F:bert.f' !W00_002_002
      call ErrWrite(ErrID,ErrCha)
      goto 554
 ...
 3125 rlke = 2500.0d0
      write(ErrCha,*) '*** Warning ; BERT25, rlke is greater than 2500'
      ErrID = 'L:546/R:bert/F:bert.f' !W00_002_003
      call ErrWrite(ErrID,ErrCha)
      goto 5021
 ...
 3085 value1 = 3600.0d0
      write(ErrCha,*)
     & '*** Warning ; BERT17, value1 is greater than 3600'
      ErrID = 'L:652/R:bert/F:bert.f' !W00_002_004
      call ErrWrite(ErrID,ErrCha)
      goto 1060
...
!$OMP THREADPRIVATE(/abcom/)
      common /ccom/  crsc(2500),ctofe,casesn,c(110)
!$OMP THREADPRIVATE(/ccom/)
      common /dcom/  dncms,d(9)
!$OMP THREADPRIVATE(/dcom/)
      common /ecom/  einc,e(491)
!$OMP THREADPRIVATE(/ecom/)
      common /fcom/  f(23)
!$OMP THREADPRIVATE(/fcom/)
      common /hcom/  h(6)
!$OMP THREADPRIVATE(/hcom/)
      common /icom/  i(52)
!$OMP THREADPRIVATE(/icom/)
      common /klmn/  ln,nrt,kmn(8)
!$OMP THREADPRIVATE(/klmn/)
      common /opcom/ part(6),pnms,poms,prtin,op(1551)
!$OMP THREADPRIVATE(/opcom/)
      common /rcom/  rcpmv,r
!$OMP THREADPRIVATE(/rcom/)
      common /scom/  sf,sqnm,s(221)
!$OMP THREADPRIVATE(/scom/)
      common /tcom/  trsym,t(9)
!$OMP THREADPRIVATE(/tcom/)
      common /uvwxz/ zee,uvwx(18)
!$OMP THREADPRIVATE(/uvwxz/)
...
c
      ...
      save kkrou    !FURUTA
!$OMP THREADPRIVATE(kkrou)
      data kkrou/0/ !FURUTA

      save lg !FURUTA
!$OMP THREADPRIVATE(lg)
c ----------------------------------------------------------------------
c
      inmiv = iv
      i5=curr(1)
