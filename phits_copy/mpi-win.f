...
*-----------------------------------------------------------------------
               ...
               if( ierr .ne. mpi_success ) then
                 ...
                 ErrID = 'L:44/R:paraint/F:mpi-win.f' !E84_001_002
...
*-----------------------------------------------------------------------
     ...
     &                       ' ->> '//filnm(1:nfiln)
                 ErrID = 'L:75/R:paraint/F:mpi-win.f' !E84_002_002
                 call ErrWrite(ErrID,ErrCha)
...
*-----------------------------------------------------------------------
! T.Sato 2018/1/18, Logname is not necessary for Windows MPI
...
*-----------------------------------------------------------------------
     ...
     &               maxbc0, maxca0
            ...
            if( nmbch0 .gt. nbchmax ) then !FURUTA2016/03/10 kvlmax->nbchmax
             ...
             ErrCha = ''
             ErrID = 'L:277/R:paraiset/F:mpi-win.f' !E84_003_002
...
!$OMP THREADPRIVATE(/errorcom/)
      ...
      integer*8 :: iransb64 ! S.H. xorshift (2020.2.4)
...
!$OMP THREADPRIVATE(/randtp/)
     ...
     &  .or.idnum.eq.120)then ! error from JAM
       if(ncascerr.eq.0) then ! first time called this routine
        ...
        ErrID = 'L:881/R:parastop/F:mpi-win.f' !E84_004_002
        call ErrWrite(ErrID,ErrCha)
        Select Case(idnum)
        case(111)
