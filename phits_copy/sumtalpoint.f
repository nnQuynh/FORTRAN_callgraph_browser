************************************************************************
*                                                                      *
      subroutine sumtal_read_tpoint(m,iax,ntf,ierr)
*                                                                      *
...
!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_stdev_point(m,ntf,
     &                             np,nr,ne,nm,nt,
...
!-----------------------------------------------------------------------
      if( ntf > 1 ) then
       if( maxcasd /= maxcasres ) then
        ...
        ErrCha = ''
        ErrID = 'L:276/R:sumtal_calc_stdev_point/F:sumtalpoint.f' !E53_002_002


        write(*,'(/'' ***** Error in sumtal calc stdev pointreg *****''
     &            /)')
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_stdev_point


!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_average_point(m,ntf,nfile,
     &                               np,nr,ne,nm,nt,
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_average_point
