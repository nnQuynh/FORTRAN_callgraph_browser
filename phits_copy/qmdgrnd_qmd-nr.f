...
************************************************************************
      ...
      use QMD_COOD2_MOD, only : inun0,iavd0,ihis0,ichg0,inuc0,ibry0,
     & inds0,r0,p0, nqmdm
...
*-----------------------------------------------------------------------
            ...
            do i = 1, massal
               ...
               do m = 1, 3
                  ...
                  iavd0(j) = iavd(i)
                  ihis0(j) = ihis(i)
                  iesc0(j) = iesc(i)      ! S.Abe 2020/09/29
...
*-----------------------------------------------------------------------
            ...
            do i = 1, massal
               ...
               do m = 1, 3
                  ...
                  iavd(i) = iavd0(i)
                  ihis(i) = ihis0(i)
                  iesc(i) = iesc0(i)      ! S.Abe 2020/09/29
...
!$OMP THREADPRIVATE(/qmdsuc/)
      ...
      common /qmdscmpar/ iesc(nnnn)
!$OMP THREADPRIVATE(/qmdscmpar/)
      common /qmdscmparr/ iescr(nnnn)
!$OMP THREADPRIVATE(/qmdscmparr/)
...
*-----------------------------------------------------------------------
            ...
            do i = 1, massal
               ...
               do m = 1, 3
                  ...
                  iavdr(j) = iavd(i)
                  ihisr(j) = ihis(i)
                  iescr(j) = iesc(i)      ! S.Abe 2020/09/29
...
*-----------------------------------------------------------------------
            ...
            do i = 1, massal
               ...
               do m = 1, 3
                  ...
                  iavd(i) = iavdr(i)
                  ihis(i) = ihisr(i)
                  iesc(i) = iescr(i)      ! S.Abe 2020/09/29
...
!$OMP THREADPRIVATE(/rannum/)
      ...
      common /const56/ rzta0, rzpr0
!$OMP THREADPRIVATE(/const56/)
