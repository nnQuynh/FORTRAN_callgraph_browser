...
*                                                                      *
*        anal-006 : for transverse energy                              *
*                                                                      *
*        Purpose:                                                      *
*                                                                      *
...
*-----------------------------------------------------------------------
      ...
      if( kelst .eq. 1 ) then
         ...
         else if( ik .eq. 1 .or. ik .eq. 2 ) then
...
*-----------------------------------------------------------------------
         ...
         write(io,'(10(1pe11.4))') elab*1000.0, ( pxstt(i), i = 1, 4 )
