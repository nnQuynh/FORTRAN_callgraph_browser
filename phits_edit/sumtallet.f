!***********************************************************************
!                                                                      *
      subroutine sumtal_read_tlet(m,iax,ntf,ierr)
!                                                                      *
!     original routine is read_tlet in restlet.f                       *
!                                                                      *
...
*-----------------------------------------------------------------------
  999   continue
      ...
      end subroutine sumtal_read_tlet


!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_stdev_letreg(m,ntf,
     &                             np,ne,nr,
...
!-----------------------------------------------------------------------
      if( ntf > 1 ) then
       if( maxcasd /= maxcasres ) then
        ...
        ErrCha = ''
        ErrID = 'L:343/R:sumtal_calc_stdev_letreg/F:sumtallet.f' !E60_001_001


        write(*,'(/'' ***** Error in sumtal calc stdev letreg *****''
     &            /)')
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_stdev_letreg



!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_stdev_letrz(m,ntf,
     &                             np,ne,nr,nz,
     &                             sumfactor,weightRate,
     &                             trRES,trSUMTAL,
     &                             resc2SUMTAL,resc3SUMTAL,
...
!-----------------------------------------------------------------------
      if( ntf > 1 ) then
       if( maxcasd /= maxcasres ) then
        ...
        m_err = 'maxcas is inconsistent.'
        ErrCha = ''
        ErrID = 'L:491/R:sumtal_calc_stdev_letrz/F:sumtallet.f' !E60_001_002


        write(*,'(/'' ***** Error in sumtal calc stdev letrz *****''/)')
        call ErrWrite(ErrID, ErrCha)
        write(*,'('' error = '',(a)/)') trim(m_err)
       end if
      end if
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_stdev_letrz



!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_stdev_letxyz(m,ntf,
     &                             np,ne,nx,ny,nz,
     &                             sumfactor,weightRate,
     &                             trRES,trSUMTAL,
     &                             resc2SUMTAL,resc3SUMTAL,
...
!-----------------------------------------------------------------------
      if( ntf > 1 ) then
       if( maxcasd /= maxcasres ) then
        ...
        m_err = 'maxcas is inconsistent.'
        ErrCha = ''
        ErrID = 'L:646/R:sumtal_calc_stdev_letxyz/F:sumtallet.f' !E60_001_003


        write(*,'(/'' ***** Error in sumtal calc stdev letxyz *****''
     &            /)')
        call ErrWrite(ErrID, ErrCha)
        write(*,'('' error = '',(a)/)') trim(m_err)
       end if
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_stdev_letxyz



!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_average_letreg(m,ntf,nfile,
     &                               np,ne,nr,
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_average_letreg



!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_average_letrz(m,ntf,nfile,
     &                               np,ne,nr,nz,
     &                               sumfactor,weightRate,sumWR,
     &                               trRES,trSUMTAL,
     &                               resc2SUMTAL,resc3SUMTAL,
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_average_letrz



!***********************************************************************
!                                                                      *
      subroutine sumtal_calc_average_letxyz(m,ntf,nfile,
     &                               np,ne,nx,ny,nz,
     &                               sumfactor,weightRate,sumWR,
     &                               trRES,trSUMTAL,
     &                               resc2SUMTAL,resc3SUMTAL,
...
!-----------------------------------------------------------------------
      ...
      end subroutine sumtal_calc_average_letxyz
