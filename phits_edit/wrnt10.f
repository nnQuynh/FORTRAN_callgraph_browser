************************************************************************
*                                                                      *
      subroutine wrnt10(data)
*                                                                      *
*       output the proton information to the proton cut-off file.      *
*       modified by K.Niita on 21/08/2001                              *
*                                                                      *
...
*-----------------------------------------------------------------------
         ...
         if( ipcut .eq. 0 ) return

*-----------------------------------------------------------------------

         if( ipcut .eq. 2 .and. ncall .eq. 0 ) then

            write(10) real(rflag), real(rflag), real(rflag),
...
*-----------------------------------------------------------------------
         ...
         if( data(1) .lt. 0.0 ) then
            ...
            if( nd .gt. 0 ) then
               ...
               write(10) real(rd),real(nn),(real(bufr(i)),i=1,nd)
...
*-----------------------------------------------------------------------
         ...
         do i = 1, 10
            ...
            if( abs( data(i) ) .gt. 1.d+61 ) then
               ...
               write(6,'(/''*** Error in wrnt10, data('',i2,
...
*         write information on file 10 if nd > 2000
*-----------------------------------------------------------------------
