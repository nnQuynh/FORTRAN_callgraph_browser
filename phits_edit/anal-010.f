...
*                                                                      *
*        anal-010 : for nuclear data test                              *
*                                                                      *
*        Purpose:                                                      *
*                                                                      *
...
*-----------------------------------------------------------------------
            ...
            wi(1) = cos(  15.0 * pi / 180.0 )
            wt(1) = cos(  25.0 * pi / 180.0 )

            wi(2) = cos(  55 * pi / 180.0 )
            wt(2) = cos(  65 * pi / 180.0 )

            wi(3) = cos(  115 * pi / 180.0 )
            wt(3) = cos(  125 * pi / 180.0 )
...
*-----------------------------------------------------------------------
            ...
            call jbook1(1,'alpha EVAP linear',
...
*-----------------------------------------------------------------------
            ...
            if( ik .eq. 0 ) then
               ...
               if( iz .eq. 2 .and. in .eq. 2 ) then
                  ...
                  call jfill1(1,ekin,cosa,sdmfac,we/2.0/pi*qmdfac)
