************************************************************************
*                                                                      *
      subroutine wrnt13(data)
*                                                                      *
*       output the photon, electron and positron                       *
*       information to the photon cut-off file.                        *
*       modified by K.Niita on 2002/10/16                              *
*                                                                      *
...
*-----------------------------------------------------------------------
         ...
         if( igcut .eq. 0 ) return

*-----------------------------------------------------------------------

         if( igcut .eq. 2 .and. ncall .eq. 0 ) then

            write(13) real(rflag), real(rflag), real(rflag),
...
*-----------------------------------------------------------------------
         ...
         if( data(1) .lt. 0.0 ) then
            ...
            if( nd .gt. 0 ) then
               ...
               write(13) real(rd),real(nn),(real(bufr(i)),i=1,nd)
...
*-----------------------------------------------------------------------
               ...
               if( igcut .le. 2 .and. n .ne. 3 ) return
               if( igcut .eq. 3 .and. n .ne. 3 .and.
     &                                n .ne. 4 .and.
     &                                n .ne. 5 ) return
...
*-----------------------------------------------------------------------
         ...
         do i = 1, 10
            ...
            if( abs( data(i) ) .gt. 1.d+61 ) then
               ...
               write(6,'(/''*** Error in wrnt13, data('',i2,
...
*-----------------------------------------------------------------------
*     the same position as previous one
*-----------------------------------------------------------------------
...
*         write information on file 13 if nd > 2000
*-----------------------------------------------------------------------
