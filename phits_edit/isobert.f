...
!$OMP THREADPRIVATE(/mecc/)
      common/matis/b(7,100),mont
!$OMP THREADPRIVATE(/matis/)
      common/statis/bm(4),sb(4),sbs(4),mob
!$OMP THREADPRIVATE(/statis/)
      common/hiro/ st(8000)
!$OMP THREADPRIVATE(/hiro/)
      common/palcom/npl(2),monin
!$OMP THREADPRIVATE(/palcom/)
