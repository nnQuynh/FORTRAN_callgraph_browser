...
*                                                                      *
*        anal-008 : for DPA cross section                              *
*                                                                      *
*        Purpose:                                                      *
*                                                                      *
*              user subroutine for analysis                            *
*                                                                      *
*        Last modified 2021/06/23 Y. Iwamoto                           *
************************************************************************
...
*-----------------------------------------------------------------------
         ...
         if( ik .eq. 0 ) then
               ...
               call dpaevl(z1,a1,z2,a2,ext,dpn)
...
*-----------------------------------------------------------------------
         ...
         if( ik .eq. 0 ) then
            ...
            if( iz .eq. 1 .and. in .eq. 1 ) then
               ...
               pxstt(kk) = pxstt(kk) + dpn

            if( kelst .eq. 1 .and.
     &          iz .gt. 0 .and. in .gt. 0 ) then
...
*-----------------------------------------------------------------------
     ...
     &       * pi * bmax0**2 * 10.0 / 1000.0
         ...
         pxstt(5) = pxstt(4) + pxstt(5)
            ...
            call dpaeme(z1,a1,z2,a2,ein,dpn,itdpa,iteth)
                dpn = dpn * 1.0d24

         write(io,'(4(1pe11.4))') elab*1000.0, dpn,
     &   pxstt(5), pxstt(5)+dpn
*-----------------------------------------------------------------------
